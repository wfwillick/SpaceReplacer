...
Write-Progress -Id 1 -Activity "Folders" -Completed -PercentComplete 100 -Status "Completed"
...
$endform.Text = 'Space Replacing Script'
$endform.Size = New-Object System.Drawing.Size(320,200)
$endform.StartPosition = 'CenterScreen'

$finishButton = New-Object System.Windows.Forms.Button
$finishButton.Location = New-Object System.Drawing.Point(120,120)
$finishButton.Size = New-Object System.Drawing.Size(75,23)
$finishButton.Text = 'Finish'
$finishButton.DialogResult = [System.Windows.Forms.DialogResult]::Abort
$endform.AcceptButton = $finishButton
$endform.Controls.Add($finishButton)

$endlabel = New-Object System.Windows.Forms.Label
$endlabel.Location = New-Object System.Drawing.Point(10,20)
$endlabel.Size = New-Object System.Drawing.Size(280,100)
$endlabel.Text = "Renaming complete: $($folders.Count) folders and $($files.Count) files were found in the selected path. 
...
if ($endresult -eq [System.Windows.Forms.DialogResult]::Abort)
{
    Exit
}